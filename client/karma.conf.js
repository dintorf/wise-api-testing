...
module.exports = function (config) {
	config.set({
		...
		files: [
			...
			'app/modules/LoopBack/LoopBackModule.js',
			'app/modules/LoopBack/LoopBackCtrl.js',
			'app/modules/LoopBack/LoopBackRoute.js',
			'app/modules/LoopBack/LoopBackService.js',
			'app/modules/LoopBack/LoopBack-test.js',
			...
			'app/modules/contacts/contacts-test.js',
			'app/modules/marketing/marketingModule.js',
			'app/modules/marketing/marketingCtrl.js',
			'app/modules/marketing/marketingRoute.js',
			'app/modules/marketing/marketingService.js',
			'app/modules/marketing/marketing-test.js',
		],
